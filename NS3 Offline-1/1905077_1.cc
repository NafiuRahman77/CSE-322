...
int main(int argc, char *argv[]) {
    ...
    cmd.AddValue("coverage-area-factor", "Set coverage area", coverage_area_factor);
    ...
    channelLeft.AddPropagationLoss("ns3::RangePropagationLossModel", "MaxRange", DoubleValue(coverage_area_factor * txRange));
    ...
    channelRight.AddPropagationLoss("ns3::RangePropagationLossModel", "MaxRange", DoubleValue(coverage_area_factor * txRange));
    ...
    radius->SetAttribute("Variance", ns3::DoubleValue(5*txRange * 3));
